...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route('banner.index')}}">Banner</a> <a href="{{route('banner.create')}}" class="current">Add New Banner</a> </div>
