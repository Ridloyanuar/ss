        ...
        <tr>
          <td style="padding:0px 30px 11px 30px;font-size:0;background-color:#ffffff;border-bottom:1px solid #f0f0f5;border-color:rgba(201,201,207,.35);">
            ...
            <div class="col-lge" style="display:inline-block;width:100%;max-width:395px;vertical-align:top;padding-bottom:20px;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
              <p style="margin-top:0;margin-bottom:12px;">Terimakasih telah mendaftar sebagai pelanggan di SayurSembalun</p>
              <p style="margin-top:0;margin-bottom:18px;">Untuk melanjutkan pendaftaran mohon untuk melakukan verifikasi email dibawah ini:</p>
              <p style="margin:0;text-align:center;">
                <a href="{{$data['verification']}}" style="background: #ff3884; text-decoration: none; padding: 10px 25px; color: #ffffff; border-radius: 4px; display:inline-block; mso-padding-alt:0;text-underline-color:#ff3884">
                  <span style="mso-text-raise:10pt;font-weight:bold;">Verifikasi Email</span>
                </a>
              </p>
            </div>
          </td>
